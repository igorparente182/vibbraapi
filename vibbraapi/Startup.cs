...
namespace vibbraapi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<VibbraContext>(opt => opt.UseSqlServer(Configuration.GetConnectionString("vibbradb")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "vibbraapi", Version = "v1" });
            });
